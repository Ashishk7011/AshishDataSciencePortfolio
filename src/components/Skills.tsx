...
const Skills = () => {
  const skillCategories = [
    ...
    },
    {
      ...
      skills: ["Ms Excel", "VS Code", "Jupyter", "MLflow", "DagsHub", "Docker", "FastAPI", "Flask", "GitHub", "Streamlit", "DVC", "MLflow", "DagsHub", "LangChain", "LangGraph", "Streamlit", "ChromaDB", "BM25", "OpenAI", "Ollama", "RAG"]
    },
    {
      icon: Cloud,
