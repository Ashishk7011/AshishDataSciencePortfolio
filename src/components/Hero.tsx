  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center px-4 py-20">
      <div className="max-w-6xl mx-auto text-center animate-fade-in">
        ...
        <p className="text-xl md:text-3xl text-muted-foreground mb-8 max-w-3xl mx-auto">
          Leveraging Data Science, Machine Learning, and MLOps to drive data-driven decision making and business growth
        </p>
    ...
    >     
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-3 gap-8">
          {[
            { value: "1+", label: "Years Experience in Data Analysis" },
